...
struct UserPreferences
{
    ...
    static var notifyMeSetting = NotificationSetting(name: "Notify me...", options: ["At time of event", "1 hour before", "2 hours before", "5 hours before", "Morning of (7 am)", "1 day before"])
